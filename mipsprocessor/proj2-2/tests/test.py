...
p2sc_tests = [
  ...
  ("CPU addi/ori",
        TestCase(os.path.join(file_locations,'test1.circ'),
                [[0, 0, 0, 0x0, 0x0, 0, 0x0, 0x20100014],
                 [0x14, 0, 0, 0x0, 0x0, 1, 0x4, 0x22110005],
                 [0x14, 0x19, 0, 0x0, 0x0, 2, 0x8, 0x36310002],
                 [0x14, 0x1B, 0, 0x0, 0x0, 3, 0xC, 0x00000000],
                 [0X14, 0x1B, 0, 0x0, 0x0, 4, 0x10, 0x00000000]]), "cpu"),
  ("CPU addi/beq",
        TestCase(os.path.join(file_locations,'test2.circ'),
                [[0, 0, 0, 0x0, 0x0, 0, 0x0, 0x22100001],
                 [1, 0, 0, 0x0, 0x0, 1, 0x4, 0x12300002],
                 [1, 0, 0, 0x0, 0x0, 2, 0x8, 0x22100001],
                 [2, 0, 0, 0x0, 0x0, 3, 0xC, 0x22100001],
                 [3, 0, 0, 0x0, 0x0, 4, 0x10, 0x22100001],
                 [4, 0, 0, 0x0, 0x0, 5, 0x14, 0x22100001]]), "cpu"),
  ("CPU lw/sw",
        TestCase(os.path.join(file_locations,'test3.circ'),
                [[0, 0, 0, 0x0, 0x0, 0, 0x0, 0x3C011001],
                 [0, 0, 0, 0x0, 0x0, 1, 0x4, 0x34210000],
                 [0, 0, 0, 0x0, 0x0, 2, 0x8, 0x00018021],
                 [0x10010000, 0, 0, 0x0, 0x0, 3, 0xC, 0x20110005],
                 [0x10010000, 5, 0, 0x0, 0x0, 4, 0x10, 0xAD110000],
                 [0x10010000, 5, 0, 0x0, 0x0, 5, 0x14, 0x8D120000],
                 [0x10010000, 5, 5, 0x0, 0x0, 6, 0x18, 0xAD120004]]), "cpu"),
  ...
  ("CPU: sltiu,slti,or,andi,sll",
       TestCase(os.path.join(file_locations,'test4-1.circ'),
                [[0,0x0,0x0,0x0,0x7fffeffc,0,0x0,0x22100063],
                 [0x63, 0x0, 0x0, 0x0, 0x7fffeffc, 1, 0x4, 0x2e110064],
                 [0x63, 0x1, 0x0, 0x0, 0x7fffeffc, 2, 0x8, 0x12200001],
                 [0x63, 0x1, 0x0, 0x0, 0x7fffeffc, 3, 0xC, 0x00018880],
                 [0x63, 0x0, 0x0, 0x0, 0x7fffeffc, 4, 0x10, 0x24080004],
                 [0x63, 0x4, 0x0, 0x0, 0x7fffeffc, 5, 0x14, 0x32080002],
                 [0x63, 0x4, 0x2, 0x0, 0x7fffeffc, 6, 0x18, 0x02328825],
                 [0x63, 0x6, 0x2, 0x0, 0x7fffeffc, 7, 0x1c, 0x2a30ff9c],
                 [0x0, 0x6, 0x2, 0x0, 0x7fffeffc, 7, 0x1c, 0x2a30ff9c]]),"cpu"),

("CPU: sltu,sra,addu,and",
       TestCase(os.path.join(file_locations,'test5.circ'),
                [[0,0x0,0x0,0x0,0x7fffeffc,0,0x0,0x22100063],
                 [0x63, 0x0, 0x0, 0x0, 0x7fffeffc, 1, 0x4, 0x2231fffb],
                 [0x63, 0xfffffffb, 0x0, 0x0, 0x7fffeffc, 2, 0x8, 0x0212882b],
                 [0x63, 0x0, 0x0, 0x0, 0x7fffeffc, 3, 0xC, 0x02129021],
                 [0x63, 0x0, 0x63, 0x0, 0x7fffeffc, 4, 0x10, 0x02328824],
                 [0x63, 0x0, 0x63, 0x0, 0x7fffeffc, 5, 0x14, 0x00109083],
                 [0x63, 0x4, 0x18, 0x0, 0x7fffeffc, 6, 0x18, 0x00109083]]),"cpu"),
]
